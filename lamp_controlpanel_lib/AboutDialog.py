...
class AboutDialog(Gtk.AboutDialog):
    ...
    def __new__(cls):
        ...
        """
        builder = get_builder('AboutLampControlpanelDialog')
        new_object = builder.get_object("about_lamp_controlpanel_dialog")
    ...
    def finish_initializing(self, builder):
        ...
        to finish initializing the start of the new AboutLampControlpanelDialog
        instance.
