...
class PreferencesDialog(Gtk.Dialog):
    ...
    def __new__(cls):
        ...
        """
        builder = get_builder('PreferencesLampControlpanelDialog')
        new_object = builder.get_object("preferences_lamp_controlpanel_dialog")
    ...
    def finish_initializing(self, builder):
        ...
        finish initializing the start of the new PerferencesLampControlpanelDialog
        instance.
