...
from . lamp_controlpanelconfig import get_data_file
...
def get_builder(builder_file_name):
    ...
    builder = Builder()
    builder.set_translation_domain('lamp-controlpanel')
...
def set_up_logging(opts):
    ...
    lib_logger = logging.getLogger('lamp_controlpanel_lib')
